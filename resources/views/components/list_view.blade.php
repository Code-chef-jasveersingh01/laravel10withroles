...
<div class="row">
    <div class="col-lg-12">
        <div class="card" @if(isset($card_style) && $card_style == '1') style="width: min-content;" @endif>
            ...
            @endif
            <div class="card-body" @if(isset($card_body_style) && $card_body_style == '1') style="width: max-content;" @endif>
