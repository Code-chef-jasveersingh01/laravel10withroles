...
@show
    ...
    {{-- @include('admin.models.notification_detail_modal') --}}
    @include('admin.models.super_admin_list_modal')
    <x-modal>
      <x-slot name="id">RejectDeleteUserRequest</x-slot>
      <x-slot name="modalSize">modal-m</x-slot>
      <x-slot name="modalTitle">{{__('main.request_reject')}}</x-slot>
      <x-slot name="modalFormBody">
        <div id="RejectDeleteUserRequestBody"></div>
      </x-slot>
